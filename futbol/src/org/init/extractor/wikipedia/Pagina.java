...
/**
 * Clase que representa a una página particular de Wikipedia, la cual puede estar asociada a plantillas y atributos de estas
 * @author fede
 *
 */
public class Pagina {
	...
	/**
	 * Constructor de Página que recibe el nombre y realizará la consulta que le traiga el contenido
	 * 
	 * @param nombre nombre que se le dará a la página
	 * @throws MalformedURLException
	 */
	public Pagina (String nombre, String idPagina, Plantilla padre) throws MalformedURLException
	{
		this.nombre = nombre;
		this.idPagina = idPagina;
		this.plantillaPadre = padre;
		this.url = new URL(Constantes.ENCABEZADO_URL + nombre.replace(" ", "_"));
		this.urlAPI = new URL(Constantes.ENCABEZADO_API_PAGINA + nombre.replace(" ", "_"));
	...
	public void generarContenido() {
		...
		JSONObject json = (JSONObject) JSONSerializer.toJSON(this.getContenido());
	...
	/**
	 * Método que carga los atributos del template de wikipedia a la página, respetando el formato de mapeo establecido
	 */
