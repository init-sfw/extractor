...
/**
 * Clase que representa originalmente una plantilla de wikipedia para contener sus valores y otorgar
 * la funcionalidad que le corresponde en cuanto a su url, sus atributos y las páginas que la implementan.
 * 
 * @see <a href="http://es.wikipedia.org/wiki/Ayuda:Plantillas">Wikipedia:Plantilla</a>
 * 
 * @author fbobbio
 *
 */
public class Plantilla {
	...
	/**
	 * Método que carga todas las páginas que correspondan a la plantilla seteada con su infobox
	 * correspondiente, sus atributos y toda la información de la página.
	 * 
	...
	public void cargarPaginas(Mapper mapper) throws MalformedURLException {
		...
		String stringListaPaginas = Request.requestGeneral(this.getUrl().toString());
		JSONObject listaPaginas = convertStringToJSONObject(stringListaPaginas);

		System.out.println("\nListado de páginas encontradas con la plantilla " + this.nombre + ":\n\n"
		...
		// Recorro el arrayProcesado, busco cada una de sus páginas y traigo el resultado en json que guardo en arrayInfoboxes
