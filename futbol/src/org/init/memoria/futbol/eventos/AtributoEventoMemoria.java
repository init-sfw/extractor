...
/**
 * Clase que representa a un atributo de un evento que será compatible al formato de Memoria, 
 * sobre el cual se harán los mapeos de atributos extraídos de la ficha y demás datos necesarios
 * 
 * @author fbobbio
 *
 */
